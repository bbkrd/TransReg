...
//        double upper = node.getDouble(TransRegOptionsPanelController.UPPER_LIMIT_STRING, Math.pow(10, -4));
//        double lower = node.getDouble(TransRegOptionsPanelController.LOWER_LIMIT_STRING, Math.pow(10, -12));
